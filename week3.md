...
[1st Iteration](/IMG_0722.jpeg)
  My first attempt at revamping the original graphic was to display the information in a traditional bar chart. However, after drawing the sketch out I realize that this chart does not give any more information than the map chart. Upon, feedback there was an understanding of what te chart was displaying, but it certaintly was not visualy appealing and rather busy. 

[2nd Iteration](/IMG_0723.jpeg)
  My second interation returned to the original map design. I debated about including State labels but felt that it would make the chart too cluttered and wanted the visualization to remain simple yet informative. 
